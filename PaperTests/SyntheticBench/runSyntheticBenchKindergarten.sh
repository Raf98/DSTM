    ...
    do
        ...
        do
            ...
            do
                ...
                for i in $(seq 0 9);
                do
                    echo "Test $i for TRMIKindergarten: $DELAY_INTERVAL delayInterval"
                    printf "TRMIKindergarten\t$NCLIENT\t"
                    ./runSyntheticBench_CMsParams.sh $NSERVER $NOBJSERVER $NCLIENT $WRITES $NTRANS $NOBJTRANS 5 $DELAY_INTERVAL
                done
