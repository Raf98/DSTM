...
for wp in writes_percentage:
    for opt in objs_per_transaction:
        for nohte in number_of_ht_entries:
            ...
            ax.set_title(f"DHT\nNúmero de buckets por HT: {nohte}, Porcentagem de escritas: {wp} %, Objetos por transação:{opt}", fontsize=24)
            ...
            fig.set_figwidth(19)
            fig.savefig(f"Plots/pt-br/NKEYS: {number_of_keys}, NHTENTRIES: {nohte}, WRITES: {wp}, NOBJTRANS:{opt}.png")
            n+=1
            i+=1
