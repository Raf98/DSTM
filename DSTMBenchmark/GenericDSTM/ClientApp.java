...
public class ClientApp {
        ...
        public void executeClient(ChooseOP cop, DSTMBenchmark.GenericDSTM.SaveData saveData, DSTMBenchmark.GenericDSTM.ExecTransaction et, String args[]) throws Exception {
                ...
                try {
                        for (int i = 0; i < transactions; i++) {
                                ...
                                et.execTransaction(robjects, op, contentionManager, usesDynamicParams, 
